...
<body>
 <div id="wrap">
    ...
    <div class="title">
      <h1>내 정보 보기 </h1>
      <p class="prec">최종학력,포트폴리오,대표작품 수정은 1대1 문의하기를 이용해주세요.</p>
    </div>
    <form action="add_user_db.do" method="post">
      <table class="table_a">
        ...
        <tr>
          ...
          <td>
            <input type="password" class="middle" name="passwd" value="${passwd}" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <input type="text" class="middle" placeholder="주민등록상 이름을 입력해주세요." name="koreanName" value="${koreanName}"/>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <input type="text" class="middle" name="englishName" value="${englishName}"/>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="text" class="small" name="major" value="${major}"/>
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
 			  <input type="text" class="small" value="${priceAvg}">
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="email"class="small" name="email" value="${email}"/>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <input type="text" class="small" value="${sns}" />
          </td>
        </tr>
      </table>
      <div class="button-group">
        <button class="gbtn normal gray"><a href='<c:url value="/signup/myInfoChange.jsp"/>'>수정 완료</a></button>
      </div>
    </form>
  </div>
