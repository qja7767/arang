...
<head>
  ...
  <link rel="stylesheet" href="../design/css_join/style.css">
</head>
...
<body>
  <div id="wrap">
    ...
    <div id="join_wrap">
    <div class="title">
      <h1>ARANG회원으로 가입하기</h1>
    </div>
    <form>
      <table class="table_a">
        <tr>
          <td>
            <input type="text" class="middle" placeholder="성명">
          </td>
        </tr>
        <tr>
          <td>
      ...
      <div class="login">
        <p>이미 계정이 있으신가요?&nbsp;&nbsp;</p>
        <a href="/medici/page/login.jsp"><strong>로그인<strong></a>
      </div>
    </form>
  </div>
  </div>
